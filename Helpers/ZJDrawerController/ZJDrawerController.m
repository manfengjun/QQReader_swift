...
- (void)commonInit {
    _maxLeftControllerWidth = _leftController ? 300.0f : 0.0f;
...
- (void)slidingLeftDrawer {
    if (self.isLeftDrawerOpen) {// 已经打开
        ...
        [self setupMaskViewForCenterContentView];
...
- (void)setupMaskViewForCenterContentView {
    ...
    self.maskView.backgroundColor= [UIColor colorWithRed:30/255.0 green:30/255.0 blue:30/255.0 alpha:0.3];
    [self.centerContentView addSubview:self.maskView];
}
